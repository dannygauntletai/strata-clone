  ...
  return (
    <div className="">
      ...
      <section className="py-8 bg-[#F8F9FA]">
        <h2 className="text-4xl font-extrabold text-blue-500 text-center mt-8 mb-8">STRATA SPORTS SCHOOLS EXPLAINED</h2>
        <div className="container mx-auto text-center px-4 md:px-0 pb-8">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-gray-800 mb-8 text-lg">
              Strata uses an AI-driven education platform called 2 hour learning to teach students.
            </p>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-800 mb-8 text-lg">
              At Strata, students spend the rest of the day focusing on a sport and doing life-skills workshops to become great athletes and role models in addition to being great students.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8 pb-8">
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-blue-50 p-8 rounded-lg flex items-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-blue-600 mb-4">Strata Football</h3>
                <p className="text-gray-700">Led by ex-NFL athletes and current high school football coaches.</p>
            ...
            <div className="bg-blue-50 p-8 rounded-lg flex items-center gap-6">
              <span className="text-blue-600 text-6xl">🏀</span>
              <div>
                <h3 className="text-xl font-bold text-blue-600 mb-4">Strata Basketball</h3>
                <p className="text-gray-700">Led by ex-Division I athletes and veteran high school basketball coaches.</p>
            ...
            <div className="bg-blue-50 p-8 rounded-lg flex items-center gap-6">
              <span className="text-blue-600 text-6xl">⚽</span>
              <div>
                <h3 className="text-xl font-bold text-blue-600 mb-4">Strata Soccer</h3>
                <p className="text-gray-700">Run by ex-Dvision I athletes and current high school soccer coaches.</p>
        ...
        <div className="container mx-auto px-4 md:px-8 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              ...
              <h3 className="text-xl font-bold text-blue-600 mt-2">DOUBLE YOUR INCOME</h3>
            ...
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              ...
              <h3 className="text-xl font-bold text-blue-600 mt-2 mb-2">TEACH WHAT YOU LOVE</h3>
              <p className="text-gray-600 pb-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              ...
              <h3 className="text-xl font-bold text-blue-600 mt-2 mb-2">MAKE A DIFFERENCE</h3>
              <p className="text-gray-600 pb-4">
          ...
          <div className="flex flex-col items-center justify-center space-y-8 text-center max-w-[1000px] mx-auto">
            <div className="space-y-2">
              <p className="text-gray-700 md:text-xl max-w-3xl mx-auto">
                Texas ESAs bring in $10,000 per student you recruit. We combine that we a $5,000 parent contribution for revenue of $15,000 per student.
              </p>
